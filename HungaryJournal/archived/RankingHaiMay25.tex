...
Professor Ryotaro Kamimura at Tokai University %\footnote{http://65.54.113.26/Author/3332281/ryotaro-kamimura}
, specialized on Machine Learning and Pattern Recognition; 
Computer Scientist Ellen M. Voorhees, at NIST%\footnote{http://www.linkedin.com/pub/ellen-voorhees/6/115/3b8}
...
Senior Specialist Toshihiko Yamakami %\footnote{http://www.linkedin.com/pub/toshihiko-yamakami/18/649/564}
...
%we observe that here are many authors with less publications, low rank in NPC on $D_1$ . This happends due to $D_1$ contains many conferences having less than 300 publication and many authors only publish in those conferences. Furthermore, 

%
%\begin{figure} %this figure will be at the right
%	\caption{Top 20 author ranking by SD3R vs. NPC, $\alpha_2=0.45$}
%	\label{Fig:Top20Author}
%   \centering
%    \includegraphics[width=0.45\textwidth]{D1t20aNPC}
%    \includegraphics[width=0.45\textwidth]{D1t20aSD3R}
%    \includegraphics[width=0.45\textwidth]{D2t20aNPC}
%    \includegraphics[width=0.45\textwidth]{D2t20aSD3R}
%\end{figure}
%
...
Let's look detail for some special occurences in Fig.~\ref{Fig:Top20AuthorDetail}. The citation number of Professor Jennifer Widom%\footnote{http://infolab.stanford.edu/~widom/}
...
Alon Halevy is another similar example for high citation, high H-index, high publications but lower SC4R. %\footnote{http://homes.cs.washington.edu/$\sim~$alon/}
