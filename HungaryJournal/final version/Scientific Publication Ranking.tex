...
%
\compclass{H.3.3 Information Search and Retrieval}
%
...
%If $\mathcal{K}(R_1,R_2) = 1-\alpha$, the probability of the objects of which its ranking order by $R_1$ and $R_2$ are different is around $\alpha/2$.
\\
